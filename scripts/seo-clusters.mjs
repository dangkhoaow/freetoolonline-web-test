const SEO_CLUSTER_GROUPS = [
  ...
  },
  {
    ...
    routes: ['/heic-to-jpg.html', '/svg-to-png.html', '/png-to-svg.html', '/image-to-base64.html', '/base64-to-image.html', '/extract-gif-to-image-frames.html', '/image-converter-tools/audio-converter.html', '/image-converter-tools/png-to-webp.html', '/image-converter-tools/jpg-to-webp.html', '/image-converter-tools/webp-to-png.html', '/image-converter-tools/webp-to-jpg.html', '/image-converter-tools/image-to-webp.html', '/image-converter-tools/png-to-jpg.html', '/image-converter-tools/image-format-converter.html', '/image-converter-tools/jpg-to-avif-converter.html', '/image-converter-tools/foxit-pdf-editor-browser.html', '/image-converter-tools/adobe-pdf-editor-browser.html', '/image-converter-tools/pdf-xchange-editor-browser-plugin-edge.html', '/image-converter-tools/client-side-pdf-editor-toolkit.html', '/image-converter-tools/hilbert-editor.html'],
  },
  {
    cluster: 'pdf',
