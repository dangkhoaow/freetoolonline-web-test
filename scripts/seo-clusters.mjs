const SEO_CLUSTER_GROUPS = [
  ...
  // isHubRoute() below - do NOT add endsWith('-tools.html') checks elsewhere.
  {
    ...
    routes: ['/games/snake-classic.html', '/games/retro-tank-battle.html', '/games/garden-defense.html', '/games/voxel-world-builder.html', '/games/sky-gates-flight.html', '/games/city-time-machine.html', '/games/2048-game.html', '/games/city-drive-3d.html', '/games/retro-fps-online.html', '/games/retro-highway-racer.html', '/games/hover-racing.html', '/games/retro-arcade-shooter.html', '/games/marble-maze.html', '/games/asteroid-blaster.html', '/games/hex-puzzle-blocks.html', '/games/procedural-horde-game.html', '/games/chili-blast-shooter.html', '/games/pixel-pipeline-reflex.html', '/games/medieval-wall-defense.html', '/games/cyber-slide-puzzle.html', '/games/starlight-breaker.html', '/games/night-swarm-survivor.html', '/games/neon-tower-rush.html', '/games/cyber-neon-maze.html', '/games/serpentine-3d.html', '/games/neural-particle-life.html', '/games/neon-surge-loop.html', '/games/arrow-dodge-arena.html', '/games/andromeda-star-shooter.html', '/games/pixel-spike-run.html', '/games/orbital-radius-shooter.html', '/games/species-life-battle.html', '/games/gravity-orbit-golf.html', '/games/one-tap-platformer.html', '/games/neon-circuit-racer.html', '/games/pixel-necromancer.html', '/games/thirteen-card-duel.html', '/games/abyss-signal-diver.html', '/games/inferno-soul-walker.html', '/games/sketch-turf-battle.html'],
  },
  {
    cluster: 'space-3d',
