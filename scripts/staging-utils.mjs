...
export function buildStagingBannerHtml() {
  return `<!-- SEO_BLOCK:STAGING_BANNER -->\n<div class="staging-banner" style="margin: 0 0 12px;padding: 6px 12px;background: #b00020;color: #fff;font-size: 12px;font-weight: 700;letter-spacing: 0.02em;text-align: center;position: fixed;top: 0;left: 0;width: 100vw;opacity: 0.2;height: 42px;">STAGING ENVIRONMENT - Not for production use.</div>\n<!-- END_SEO_BLOCK:STAGING_BANNER -->`;
}
