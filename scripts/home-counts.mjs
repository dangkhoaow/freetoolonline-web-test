...
export function spliceHomeBodyHtml(html, counts, ratings = null) {
  ...
  const splices = [
    ...
    { name: 'places3d_cta', re: /Tour \d+ places in 3D/, to: `Tour ${c['places-3d']} places in 3D` },
    { name: 'places3d_aria', re: /aria-label="Places 3D - \d+ interactive explorers?"/, to: `aria-label="Places 3D - ${c['places-3d']} interactive ${c['places-3d'] === 1 ? 'explorer' : 'explorers'}"` },
